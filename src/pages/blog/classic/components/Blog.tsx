import img1 from '@/assets/images/blog-post/img-1.jpg'
import img2 from '@/assets/images/blog-post/img-2.jpg'
import img3 from '@/assets/images/blog-post/img-3.jpg'
import img4 from '@/assets/images/blog-post/img-4.jpg'
          ...
          <Row>
            <Col lg={8}>
              <div className="blog-post">
                ...
                <div className="blog-box mt-5">
                  <div className="blog-img">
                    <Image src={img4} className="img-fluid rounded" alt="" />
                  </div>
                  <div className="blog-info mt-4 p-2">
                    <h4>
                      <Link to="" className="text-dark">

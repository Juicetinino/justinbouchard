            ...
            <div className="portfolioContainer row " data-isotope='{ "layoutMode": "masonry" }'>
              <Col lg={4} className="p-4 grid-item photo">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={img1} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item branding coffee">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={img9} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item branding photo">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={img7} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item branding design photo">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={img5} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item design photo">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={img11} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item branding design coffee">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={img4} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item branding design">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={img12} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item branding design photo coffee">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={img6} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item branding photo">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={img8} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item branding design photo">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={img14} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item design photo">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={img15} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item branding design photo">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={img13} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item branding design coffee">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={img16} title="Project Name">

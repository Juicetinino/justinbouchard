            ...
            <div className="portfolioContainer row" data-isotope='{ "layoutMode": "masonry" }'>
              <Col lg={4} className="p-4 grid-item photo">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={portfolio1} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item branding coffee">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={portfolio8} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item branding photo">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={portfolio5} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item branding design photo">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={portfolio2} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item design photo">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={portfolio3} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item branding design coffee">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={portfolio7} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item branding design">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={portfolio4} title="Project Name">
              ...
              <Col lg={4} className="p-4 grid-item branding design photo coffee">
                <div className="item-box">
                  <GlightBox className="mfp-image" href={portfolio6} title="Project Name">
